...
export default {
    ...
    category: 'general',
    description: 'Get session id for KØREXIA-MD',
    usage: '.pair 50931221850',
    async handler(sock, message, args, context) {
        ...
        const forwardInfo = {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363402440396622@newsletter',
                newsletterName: 'KØREXIA MD',
                serverMessageId: -1
            }
        };
        ...
        try {
            ...
            if (response.data && response.data.code) {
                ...
                const successText = `✅ *KØREXIA-MD PAIRING CODE*\n\n` +
                    `Code: *${pairingCode}*\n\n` +
                    `*How to use:*\n` +
