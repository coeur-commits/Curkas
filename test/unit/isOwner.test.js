...
vi.mock('../../config.js', () => ({
    default: { ownerNumber: '50931221850@s.whatsapp.net' }
}));
...
describe('isOwnerOrSudo', () => {
    ...
    it('owner JID matches', async () => {
        expect(await isOwnerOrSudo('50931221850@s.whatsapp.net')).toBe(true);
    });

    it('owner with device suffix matches', async () => {
        expect(await isOwnerOrSudo('50931221850:10@s.whatsapp.net')).toBe(true);
    });
    ...
    it('cleanJid strips device suffix', () => {
        expect(cleanJid('50931221850:10@s.whatsapp.net')).toBe('50931221850');
    });

    it('cleanJid strips @s.whatsapp.net', () => {
        expect(cleanJid('50931221850@s.whatsapp.net')).toBe('50931221850');
    });
