...
export function createMockSock(overrides = {}) {
    ...
    const sock = {
        ...
        groupMetadata: vi.fn(async (jid) => ({
            id: jid,
            subject: 'Test Group',
            owner: '50931221850@s.whatsapp.net',
            participants: [
                { id: '50931221850@s.whatsapp.net', admin: 'superadmin' },
                { id: '509009999999@s.whatsapp.net', admin: 'admin' },
                { id: '509001111111@s.whatsapp.net', admin: null },
                { id: '509002222222@s.whatsapp.net', admin: null },
            ]
        })),
