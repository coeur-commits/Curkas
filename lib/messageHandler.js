...
async function handleMessages(sock, messageUpdate) {
    try {
                ...
                if (stickers[hash]) {
                    ...
                    if (foundCommand) {
                        ...
                        if (foundCommand.adminOnly && isGroup) {
                            ...
                            // La commande admin appartient à l'admin du groupe.
                            // Le bot n'a pas besoin d'être admin simplement pour
        ...
        if (command.adminOnly && isGroup) {
            ...
            // adminOnly = l'utilisateur doit être admin du groupe.
            // Le statut admin du bot sera vérifié uniquement par les
            // commandes qui effectuent une action nécessitant ses droits.
            if (
                !isSenderAdmin &&
                !message.key.fromMe &&
                !senderIsOwnerOrSudo
