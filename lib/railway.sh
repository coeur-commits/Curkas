#!/bin/bash
# KØREXIA-MD Railway One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/Nsala/KØREXIA-MD/main/lib/railway.sh)
...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════╗"
echo "║       KØREXIA-MD Railway Deployer        ║"
echo "║          by Nsala            ║"
echo "╚═══════════════════════════════════════╝"
echo -e "${NC}"
...
OWNER_NUMBER=${OWNER_NUMBER:-509000000000}
